      ...
      <div style={{
        ...
        <div style={{ display: "flex", justifyContent: "flex-end", marginTop: 2 }}>
          <button onClick={() => setExpanded(e => !e)} style={{
            background: expanded ? accent + "28" : "#ffffff0f", border: ("1px solid " + accent + "66"),
            color: expanded ? accent : COLORS.text, fontSize: 11, cursor: "pointer",
            padding: "3px 8px",
      ...
      <div style={{
        ...
        <div style={{ display:"flex", alignItems:"center", justifyContent:"center", gap:8, marginTop:8, flexWrap:"wrap" }}>
          ...
          {Object.entries(THEMES).map(([id, t]) => {
            ...
            return (
              <button key={id} onClick={() => onThemeChange(id)} title={id} style={{
